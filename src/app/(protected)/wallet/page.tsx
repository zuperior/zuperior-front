  ...
  return (
    <div className="p-4 mx-auto w-full max-w-full space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-[15px] border border-black/10 dark:border-white/10 bg-black/5 dark:bg-black/40 p-6 flex flex-col items-center justify-center text-center min-h-[140px] relative overflow-visible">
            ...
            <video
              className="absolute h-20 w-20 opacity-40 left-1/2 -translate-x-1/2 top-8 md:top-12 hidden dark:block"
              autoPlay
              loop
              muted
              playsInline
      ...
      <div className="relative overflow-hidden w-full rounded-[15px] dark:bg-black bg-[#FBFAFC] p-6 md:p-[50px] text-black dark:text-white">
        <h2 className="text-[16px] md:text-[24px] font-medium tracking-tighter leading-6 md:leading-7 capitalize z-10 text-[rgb(98,66,165)] dark:text-white max-w-[55%] md:max-w-full">
          Powerful Integrated Wallet <br />
          for Seamless Transfer Between Wallet and MT5
        </h2>

        <div className="absolute top-1/2 -translate-y-1/2 right-1 md:-top-16 md:-right-15 md:translate-y-16 pointer-events-none hidden dark:block">
          <video
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button onClick={() => setOpenIn(true)} className="rounded-xl p-6 text-left dark:bg-gradient-to-br dark:from-[#1b1426] dark:to-[#221a30] bg-white border dark:border-[#2a2139] border-black/10 hover:opacity-90 relative group">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="text-sm dark:text-white/70 text-black/60 mb-1">Transfer</div>
              <div className="text-lg font-semibold dark:text-white text-black">MT5 to Wallet</div>
              <div className="text-xs dark:text-white/50 text-black/40 mt-2">Move funds into your wallet</div>
            </div>
            <div className="ml-4 flex-shrink-0">
              <ArrowRight className="h-6 w-6 dark:text-white/60 text-black/50 group-hover:dark:text-white/90 group-hover:text-black transition-colors" />
            </div>
          </div>
        </button>
        <button onClick={() => setOpenOut(true)} className="rounded-xl p-6 text-left dark:bg-gradient-to-br dark:from-[#1b1426] dark:to-[#221a30] bg-white border dark:border-[#2a2139] border-black/10 hover:opacity-90 relative group">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="text-sm dark:text-white/70 text-black/60 mb-1">Transfer</div>
              <div className="text-lg font-semibold dark:text-white text-black">Wallet to MT5</div>
              <div className="text-xs dark:text-white/50 text-black/40 mt-2">Move funds to your trading account</div>
            </div>
            <div className="ml-4 flex-shrink-0">
              <ArrowRight className="h-6 w-6 dark:text-white/60 text-black/50 group-hover:dark:text-white/90 group-hover:text-black transition-colors" />
            </div>
