...
function PerformanceStats({ 
  language = 'en' 
}: PerformanceStatsProps): React.ReactElement {
  ...
  useEffect(() => {
    ...
    .then(data => {
      ...
      iframe.title = "Autochartist Performance Statistics";
      ...
      iframe.onerror = () => {
        ...
        if (isMounted) {
          setHasError(true);
          setErrorMessage('Failed to load performance statistics');
          setIsLoading(false);
          
          overlay.innerHTML = `
            <div style="text-align: center; color: #ef4444;">
              <div style="font-size: 32px; margin-bottom: 12px;">⚠️</div>
              <p style="margin: 0 0 8px; font-size: 16px; font-weight: 500;">Failed to load performance statistics</p>
