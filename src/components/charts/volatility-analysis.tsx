...
function VolatilityAnalysis({ language = 'en' }: VolatilityAnalysisProps): React.ReactElement {
  ...
  useEffect(() => {
    ...
    .then(data => {
      ...
      iframe.title = "Autochartist Volatility Analysis";
      ...
      iframe.onerror = () => {
        ...
        if (isMounted) {
          setHasError(true);
          setErrorMessage('Failed to load volatility analysis');
          setIsLoading(false);
          
          overlay.innerHTML = `
            <div style="text-align: center; color: #ef4444;">
              <div style="font-size: 32px; margin-bottom: 12px;">⚠️</div>
              <p style="margin: 0 0 8px; font-size: 16px; font-weight: 500;">Failed to load chart</p>
...
export default memo(VolatilityAnalysis);