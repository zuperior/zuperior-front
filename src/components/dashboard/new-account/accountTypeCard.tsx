export function AccountTypeCard({
  ...
  const formatCommission = (
    comm: number | string | null | undefined,
  ): string => {
  ...
  return (
    <div
      className={`group relative flex flex-col h-[312px] w-[240px] md:w-[250px] cursor-pointer items-center text-center gap-[10px] md:gap-[15px] rounded-[15px] p-0.5 transition-all duration-200 overflow-hidden ${
        selected
          ? ""
    ...
    >
      ...
      {selected && (
        <div
          ...
          style={{
            background:
              "conic-gradient(from var(--border-angle, 0deg) at 50% 50%, transparent 0deg, transparent 270deg, rgb(163, 92, 162) 300deg, rgb(163, 92, 162) 330deg, transparent 360deg)",
            padding: "1px",
            zIndex: 0,
            animation: "border-rotate 3s linear infinite",
          }}
        >
          <div className="w-full h-full rounded-[14px] bg-gradient-to-br from-purple-50/80 via-white to-purple-50/50 dark:bg-gradient-to-br dark:from-purple-950/20 dark:via-black dark:to-purple-900/10" />
        </div>
      )}
      <div
        className={`relative z-10 w-full h-full flex flex-col rounded-[15px] bg-white dark:bg-linear-to-b from-[#070206] to-[#030103] px-2 md:px-5 pt-[15px] pb-[30px]`}
      >
        <div
        ...
        <div className="flex-1">
          ...
          <div className="mt-[15px] flex items-center flex-col gap-2.5">
            ...
            >
              Minimum Deposit{" "}
              <span className="text-gray-900 dark:text-white ml-1 text-sm">
                {formatMinDeposit(minDeposit)}
              </span>
            </p>
            ...
            >
              {spreadLabel}{" "}
              <span className="text-gray-700 dark:text-gray-300 ml-1 text-sm">
                {formatSpread(spread)}
              </span>
            </p>
            <div className="w-full h-px bg-gradient-to-r from-transparent via-purple-300 to-transparent dark:from-transparent dark:via-purple-700/50 dark:to-transparent" />
